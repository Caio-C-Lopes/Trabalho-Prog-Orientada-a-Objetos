...
import com.caio.model.Pedido;
import com.caio.service.ItemDePedidoService;
import com.caio.service.PedidoService;
import com.caio.model.Cliente;
import com.caio.service.ClienteService;
import com.caio.model.Livro;
import com.caio.service.LivroService;
        ...
        while(continua){
            ...
            switch (opcao) {
                case 1 -> {
                    ...
                    try{
                        pedidoService.validaData(dataEmissao);
                    } catch(DataInvalidaException | StringIndexOutOfBoundsException | NumberFormatException |
                            DateTimeException e){
                        System.out.println(e.getMessage());
                        break;
                    }
                ...
                case 2 -> {
                    ...
                    try{
                        pedidoService.validaData(dataCancelamento);
                    } catch(DataInvalidaException | StringIndexOutOfBoundsException | NumberFormatException |
                            DateTimeException e){
                        System.out.println(e.getMessage());
                        break;
