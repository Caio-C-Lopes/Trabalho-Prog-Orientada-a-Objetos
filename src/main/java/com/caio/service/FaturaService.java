...
public class FaturaService {
    ...
    private final ItemFaturadoService servicoItemFaturado = new ItemFaturadoService();
    ...
    public Fatura remover(int id, Cliente umCliente){ //remove e atualiza o estoque
