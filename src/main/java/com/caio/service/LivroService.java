...
import com.caio.dao.LivroDAO;
import com.caio.exception.EntidadeComListaNaoVaziaException;
import com.caio.exception.EntidadeNaoEncontradaException;
import com.caio.exception.SemLivrosException;
import com.caio.model.Livro;
...
public class LivroService {
    ...
    public Livro CadastrarLivro(String isbn, String titulo, String descricao, int qtdEstoque, int preco){
        Livro livro = new Livro(isbn, titulo, descricao, qtdEstoque, preco);
        livroDAO.incluir(livro);
        return livro;
    }

    public void AbastecerEstoqueDeTodosOsLivrosDadoUmaQuantidade(List<Livro> livros, int qtd){
        int contador = qtd;
        for(Livro livro : livros){
